<x-app-layout>
    <div class="max-w-3xl mx-auto space-y-6 px-4">
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <h1 class="text-xl font-semibold">Edit Realisasi Rincian</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <form action="{{ route('realisasi-rincian.update', $realisasi) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="realisasi_anggaran" min="0" step="0.01"
                            ...
                            value="{{ old('realisasi_anggaran', $realisasi->realisasi_anggaran) }}" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_realisasi"
                            class="w-full mt-1 border-gray-300 text-sm rounded-md focus:ring-green-600 focus:border-green-600"
                            value="{{ old('tanggal_realisasi', optional($realisasi->tanggal_realisasi)->format('Y-m-d')) }}"
                            required>
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi"
                            class="w-full mt-1 border-gray-300 text-sm rounded-md focus:ring-green-600 focus:border-green-600"
                            value="{{ old('lokasi', $realisasi->lokasi) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="catatan" rows="3"
                            class="w-full mt-1 border-gray-300 text-sm rounded-md focus:ring-green-600 focus:border-green-600"
                            placeholder="Catatan tambahan (opsional)">{{ old('catatan', $realisasi->catatan) }}</textarea>
