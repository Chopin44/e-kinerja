                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-gray-500">PJ: {{ $kegiatan->user->name }}</div>
                                <div class="text-xs text-gray-400">{{ ucfirst($kegiatan->kategori) }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm">
                                ...
                                <div>Anggaran: Rp {{ number_format($kegiatan->target_anggaran, 0, ',', '.') }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="space-y-2">
                                    <div>
