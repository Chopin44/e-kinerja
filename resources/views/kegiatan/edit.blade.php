                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <select name="kategori"
                            class="w-full mt-1 border-gray-300 text-sm rounded-md focus:ring-green-600 focus:border-green-600"
                            required>
                            <option value="belanja_langsung" {{ old('kategori', $kegiatan->kategori) ==
                                'belanja_langsung' ? 'selected' : '' }}>Belanja Langsung</option>
                            <option value="belanja_operasional" {{ old('kategori', $kegiatan->kategori) ==
                                'belanja_operasional' ? 'selected' : '' }}>Belanja Operasional</option>
                            <option value="program_prioritas" {{ old('kategori', $kegiatan->kategori) ==
                                'program_prioritas' ? 'selected' : '' }}>Program Prioritas</option>
                            <option value="kegiatan_rutin" {{ old('kategori', $kegiatan->kategori) == 'kegiatan_rutin' ?
                                'selected' : '' }}>Kegiatan Rutin</option>
                        </select>
