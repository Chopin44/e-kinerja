            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        {{ $subkegiatan->nama }}
                        {{ $subkegiatan->kegiatan->bidang->nama }}
                    </p>
                </div>
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 text-gray-700 text-xs uppercase tracking-wide">
                            ...
                            <th class="text-left font-semibold px-3 py-2.5">Anggaran</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/60">
                            <td class="px-3 py-2.5 text-gray-900">{{ $r->uraian }}</td>
                            ...
                            <td class="px-3 py-2.5">Rp {{ number_format($r->anggaran ?? 0, 0, ',', '.') }}</td>
                            <td class="px-3 py-2.5">
