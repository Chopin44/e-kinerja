...
class KegiatanPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        ...
        return $user->hasAnyRole(['admin', 'pimpinan', 'staf']);
    }

    public function view(User $user, Kegiatan $kegiatan): bool
    {
        // pimpinan hanya di bidangnya; staf hanya kalau kegiatan di bidangnya juga
    ...
    public function update(User $user, Kegiatan $kegiatan): bool
    {
        ...
        // pimpinan boleh update kegiatan di bidangnya (kalau kebijakanmu mau memperbolehkan)
        if ($user->hasRole('pimpinan')) {
            return (int)$user->bidang_id === (int)$kegiatan->bidang_id;
        }
